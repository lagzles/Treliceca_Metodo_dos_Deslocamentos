...
class Trelica(object):
    def __init__(self, h, pontos_vao, cumeeira, cumeeira_alinhada_com_pilar, vento):
        ...
        for i in range(len(pontos_vao)-1):
            ...
            parcial = barras_e_nos_trelica(self, xi, xf, primeiro_vao, pre_gdl)
            ...
            print(pre_gdl," gdl fora do método")
...
def barras_e_nos_trelica(trelica, xi, xf, primeiro_vao, pre_gdl):
    h_viga = trelica.h_viga
    ponto_i = xi
    ponto_f = xf
    vento = trelica.vento
    primeiro_vao = primeiro_vao
    pre_gdl = pre_gdl
    cumeeira = trelica.cumeeira
    cumeeira_alinhada = trelica.cumeeira_alinhada
    ...
    nos_obj = nos_objetos
    nos_objetos_lista = nos_objetos_list
    meio_vao = meio_vao
    n_vao_montantes = n_vao_montantes
