...
##no1 = nos.Nos(0, 0, 1, 2, 'x', 'x')
##no2 = nos.Nos(0, 3, 3, 4, 48, -48)
##no3 = nos.Nos(4, 0, 5, 6, 0, 'x')
##no4 = nos.Nos(4, 3, 7, 8, 0, 0)
##nos = [no1, no2, no3, no4]
noss = []
...
##b2 = b.Barras(no2, no4, e, a, gdl)
##b3 = b.Barras(no1, no2, e, a, gdl)
##b4 = b.Barras(no3, no4, e, a, gdl)
##b5 = b.Barras(no1, no4, e, a, gdl)
##b6 = b.Barras(no2, no3, e, a, gdl)
barras = []
# banzo sup
